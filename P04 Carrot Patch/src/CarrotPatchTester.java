...
public class CarrotPatchTester extends CarrotPatch {
  ...
  public static boolean test2isCloseMethod() {
    ...
    try {
      ...
      Wolf w1 = new Wolf();
      Wolf w2 = new Wolf();
      // Set Wolf at position(300,200)
      w1.setX(300);
      w1.setY(200);
      // Set second Wolf at position(600,200)
      w2.setX(600); // Wolf1 is 300px away from Wolf2
      w2.setY(200);

      if (w1.isClose(w2, Wolf.getScanRange())) { // bug! isClose() should return false here
        System.out.println(
            "Problem detected: Rabbit.isClose() returned true when it should return false.");
        return false;
      }
  ...
  public static boolean test3isCloseMethod() {
    ...
    try {
      ...
      // Set Rabbit at position(300,200)
      r.setX(300);
      r.setY(200);
     
      if (r.isClose(1000, 2000, Rabbit.getScanRange())) { // bug! isClose() should return false here
        System.out.println(
            "Problem detected: Rabbit.isClose() returned true when it should return false.");
        return false;
      }
